  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function updateCardWithData(card, repoData) {
      ...
      if (languageSwatch && repoData.language) {
        const color = languageColors[repoData.language] || "rgba(148, 163, 184, 0.6)";
    ...
    function fetchRepoData(card) {
      ...
      fetch(`https://api.github.com/repos/${repo}`, {
        ...
        .then(repoData => {
          localStorage.setItem(cacheKey, JSON.stringify({ timestamp: now, data: repoData }));
